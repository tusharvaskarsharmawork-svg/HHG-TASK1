  ...
  ({ userData }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="relative flex-1 p-4 sm:p-5 sm:pr-6 flex flex-col z-10 pb-4 sm:pb-10 overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 items-start">
            ...
            <div className="relative flex-shrink-0">
              ...
              <div className="relative w-[120px] h-[130px] sm:w-[130px] sm:h-[140px] rounded-3xl overflow-hidden border border-[#FFD31A]/40 shadow-[0_0_30px_rgba(0,0,0,0.8)] bg-[#050807]">
            ...
            <div className="flex flex-col flex-1 min-w-0 w-full pt-1">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[46px] tracking-tight text-[#FFF7EA] whitespace-normal break-words font-serif mb-0.5 sm:mb-1 leading-[1.1]">{name}</h2>

              {teamName && (
                <div className="text-lg sm:text-xl text-[#FFD31A] font-medium whitespace-normal break-words mb-0.5 sm:mb-1 font-sans tracking-wide">
                  {teamName}
                </div>
              )}

              <div className="text-xs sm:text-sm text-white/50 font-mono tracking-wider mb-2 sm:mb-3">{role}</div>
          ...
          <div className="mt-4 sm:mt-auto pt-4 sm:pt-5 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 sm:gap-5 z-10 w-full">
            <div className="flex items-end justify-between w-full sm:w-auto gap-3 sm:gap-5">
              {/* Coordinates */}
        ...
        <div className="hidden sm:flex absolute right-2 sm:right-[235px] md:right-[250px] lg:right-[260px] bottom-[26px] sm:bottom-[28px] z-[15] pointer-events-none select-none">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
        ...
        <div className="relative w-full sm:w-[260px] p-6 sm:p-5 pb-6 sm:pb-12 flex flex-col items-center text-center z-10 bg-transparent">
        ...
        {/* YELLOW FOOTER STRIP */}
        <div className="relative sm:absolute mt-auto sm:mt-0 bottom-0 left-0 right-0 h-auto sm:h-7 py-2 sm:py-0 bg-[#FFD31A] text-black font-bold flex flex-col sm:flex-row items-center justify-center z-40 px-2 sm:px-4 shadow-[0_-5px_20px_rgba(255,211,26,0.2)]">
          <span className="font-mono text-[9px] sm:text-[11px] tracking-widest sm:tracking-[0.4em] uppercase text-center sm:whitespace-nowrap sm:overflow-hidden sm:text-ellipsis leading-tight w-full">
